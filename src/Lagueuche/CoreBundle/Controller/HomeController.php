...
namespace Lagueuche\CoreBundle\Controller;
...
class HomeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('LagueucheCoreBundle:Home:index.html.twig');
    ...
    public function contactAction(Request $request)
    {
        ...
        return $this->redirect($this->generateUrl('lagueuche_core_homepage'));

        // La méthodes longue new RedirectResponse($this->get('router')->generate('oc_core_home')); est parfaitement valable
    }
}
